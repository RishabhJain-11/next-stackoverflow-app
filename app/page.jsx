    ...
    <div className="min-h-screen bg-[#0B0F17] text-white p-6 font-mono">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <Link href="/qa">
            <Button className="bg-orange-400 hover:bg-blue-600">Ask Question</Button>
          </Link>
        </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <Card className="bg-[#1A1F2B] border-gray-800">
                ...
                <CardContent>
                  ...
                  <Button variant="outline" size="sm" className="mt-3 w-full cursor-pointer">
                    Customize your feed
                  </Button>
                </CardContent>
              </Card>
                ...
                {[1, 2, 3, 4].map((i) => (
                  <div key={i} className="border-b border-gray-800 last:border-0 pb-4 last:pb-0">
                    <div className="flex justify-between items-start mb-2">
                      <h3 className="font-medium text-orange-400 hover:text-blue-400 cursor-pointer">
            ...
            <Card className="bg-[#1A1F2B] border-gray-800">
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  <h3 className="font-medium hover:text-blue-400 cursor-pointer text-orange-400">
